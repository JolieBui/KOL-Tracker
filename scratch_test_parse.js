...
const resolveCampaignKey = (r) => r.campaign || 'AM';
...
console.log();
console.log('Warnings (first 10):', merged.warnings.slice(0, 10));
if (merged.toAdd.length > 0) {
  console.log('Sample toAdd row:', merged.toAdd[0]);
}
